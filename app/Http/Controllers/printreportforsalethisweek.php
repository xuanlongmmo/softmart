...
class printreportforsalethisweek extends Controller implements FromCollection, WithHeadings
{
    use Exportable;
    ...
    {
        $dborder = new order();
        $orders = $dborder->whereBetween('created_at', [Carbon::now()->startOfWeek(), Carbon::now()->endOfWeek()])->where('id_status',5)->get();
    ...
    public function export(){
        return Excel::download(new printreportforsalethisweek(), 'orders.xlsx');
   }
