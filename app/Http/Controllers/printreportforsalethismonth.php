...
class printreportforsalethismonth extends Controller implements FromCollection, WithHeadings
{
    use Exportable;
    ...
    {
        $dborder = new order();
        $orders = $dborder->whereBetween('created_at',[Carbon::now()->startOfMonth(),Carbon::now()->endOfMonth()])->where('id_status',5)->get();
    ...
    public function export(){
        return Excel::download(new printreportforsalethismonth(), 'orders.xlsx');
   }
